...
::: {.column width="40%"}
Con `#| output: asis`
![](assets/con_config.png)
:::

::: {.column width="60%"}
Sin `#| output: asis`
![](assets/sin_config.png)
...
- Plantilla utilizada: [https://github.com/kazuyanagimoto/quarto-awesomecv-typst](https://github.com/kazuyanagimoto/quarto-awesomecv-typst)
