...
2.  Para que nuestro archivo salga bien hay que pausar los warnings y los chunks
...
::::: columns
::: {.column width="50%"}
Con `#| output: asis` ![](assets/con_config.png)
:::

::: {.column width="50%"}
Sin `#| output: asis` ![](assets/sin_config.png)
:::
:::::
...
::: footer
Documentación de las funciones [acá](https://kazuyanagimoto.com/typstcv/)
:::
...
## 📦 rig: el gestor de versiones de R {.smaller}
...
## 🖊️ Air: formateador de código R {.smaller}
...
Más información en este [link](https://nucleodeinnovacionsocial.com.ar/cursos/intro_r) o escribiendo a info@nucleodeinnovacion.com
:::
:::
:::::
...
- [Getting started with positron](https://posit-dev.github.io/positron-workshop/)